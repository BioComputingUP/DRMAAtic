...
from drmaatic.task.serializers import TaskSerializer, SuperTaskSerializer
from drmaatic.throttles import IPRateThrottleBurst, UserBasedThrottleBurst
...
class TaskViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        # Based on the user group, filter the tasks that are allowed to be seen
        allowed_scripts = []
